                ...
                <article>
                    ...
                    <div>
                        ...
                        /*
                          ...
                          @description: 8.- Mostrar la dirección IP del equipo desde el que estás accediendo.
                         */
                        
                         echo "La dirección IP es -> ", $_SERVER["REMOTE_ADDR"]; //Con REMOTE_ADDR extraemos la IP con la que accedemos al servidor
                        ?>
                </article>
            </section>
        </div>
