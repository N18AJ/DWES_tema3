                ...
                <article>
                    ...
                    <div>
                        ...
                        /*
                          ...
                          @description: 6.- Operar con fechas: calcular la fecha y el día de la semana de dentro de 60 días.
                         */
                        $fecha = date('Y-m-j'); //Creamos la fecha y su formato
                        echo "Fecha actual -> " . $fecha;
                        $nuevafecha = strtotime ( '+60 day' , strtotime ( $fecha ) ) ; //strtotime esta función añadira llos 60días a la fecha actual
                                                                                       //tambien se podria hacer de una fecha dada. 
                        $nuevafecha = date ( 'Y-m-j' , $nuevafecha );  //Formato a la fecha nueva
                        echo "<br>Fecha dentro de 60 días -> " .$nuevafecha; //Muestra de la fecha futura
                        ?>
                    </div> 
                </article>
            </section>
