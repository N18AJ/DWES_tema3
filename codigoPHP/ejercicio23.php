                ...
                <article>
                    ...
                    <div id="cont">
                       ...
                       /*
                        ...
                        @description:23. Construir un formulario para recoger un cuestionario realizado a una persona y mostrar en la misma página las preguntas y las respuestas
                        ...
                        */
                        ...
                        if (isset($$_REQUEST['enviar'])) {//Codigo que se ejecuta cuando se env�a el formulario
                        ...
                        <div id="cont">
                            ...
                            <form name="form21" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST">
                                <legend>Operaciones con numeros ENTEROS | Control de ERRORES en formularios</legend>
                                <div>
                                    ...
                                    <input  <?php
                                        ...
                                        ?> type="number" name="primerNumero" placeholder=" Introduzca un número">
                                        <?php
                                        if ($aErrores['primerNumero'] != NULL) {
                                ...
                                <div>
                                    ...
                                    <input <?php
                                        ...
                                        ?> type="number" name="segundoNumero" placeholder=" Introduzca un número">   
                                    <?php
                                    if ($aErrores['segundoNumero'] != NULL) {
