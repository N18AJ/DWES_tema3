                ...
                <article>
                    ...
                    <div>
                        ...
                        /*
                          ...
                          @description: 9.- Mostrar el path donde se encuentra el fichero que se está ejecutando.
                         */
                        echo "Path completo -> ", $_SERVER["PATH"]; //Para conocer nuestro path usamos la variable superglobal $_SERVER
                        ?>
                    </div> 
                </article>
            </section>
